...
RELEASE_IMAGE_PREFIX = env("RELEASE_IMAGE_PREFIX", default="unconfigured")
RELEASE_DEPLOYED_AT = env("RELEASE_DEPLOYED_AT", default="")
STAGING_STATUS_CA_FILE = env("STAGING_STATUS_CA_FILE", default="")
STAGING_REVIEW_URL = env("STAGING_REVIEW_URL", default="")
PRODUCTION_STATUS_CA_FILE = env("PRODUCTION_STATUS_CA_FILE", default="")
PRODUCTION_REVIEW_URL = env("PRODUCTION_REVIEW_URL", default="")
DEPLOYMENT_REMINDER_HOURS = env.int("DEPLOYMENT_REMINDER_HOURS", default=48)
